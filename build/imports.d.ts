...
export { AccessFormData, NavData } from '../stores/formsData';
export { userDataStore, usersdata, crudusers, isSign, enteredColor, Pokemon, currentUser } from '../stores/myStore';
